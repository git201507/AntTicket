//
//  PlannerInstructionViewController.m
//  AntTicket
//
...
#import "PlannerInstructionViewController.h"
#import "BasicConfigPath.h"
#import "GlobleURL.h"
#import "BasicUserDef.h"
#import "BasicAccountInterFace.h"

@interface PlannerInstructionViewController ()
{
...
@implementation PlannerInstructionViewController
...
- (void)viewDidLoad
{
    ...
    NSString *url = [[BasicConfigPath getConfigPathWithKey:@"MAINNETPATH"] stringByAppendingString:FinancePlanner_FinancialMoreDetailURL(accountInfo.userId)];
