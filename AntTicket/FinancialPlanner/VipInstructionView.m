...
@implementation VipInstructionView
- (void)dealloc
{
...
- (IBAction)toVIP:(id)sender
{
    ...
    {
        [MyAccountVC performSegueWithIdentifier:@"vipInstruction" sender:nil];
    }
}
#pragma mark - 自己的方法
