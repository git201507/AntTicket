...
@implementation TickerLevelView
- (void)dealloc
{
...
- (IBAction)financialPlanner:(id)sender
{
    ...
    {
        [MyAccountVC performSegueWithIdentifier:@"tickerLevel" sender:nil];
    }
}
#pragma mark - 自己的方法
