//
//  TickerInstructionViewController.m
//  AntTicket
//
...
#import "TickerInstructionViewController.h"
#import "BasicConfigPath.h"
#import "GlobleURL.h"
#import "BasicUserDef.h"
#import "BasicAccountInterFace.h"

@interface TickerInstructionViewController ()
{
...
@implementation TickerInstructionViewController
...
- (void)viewDidLoad
{
    ...
    NSString *url = [[BasicConfigPath getConfigPathWithKey:@"MAINNETPATH"] stringByAppendingString:FinancePlanner_TickerLevelURL(accountInfo.userId)];
